...
public:
Character(){};
Character(const QString &n, const QString &d, const int &f, const bool &h, const int &t, const int &da, std::vector<Item> &i)
    : name(n), description(d), frequency(f), hatesPlayer(h), timesEncountered(t), daysSinceEncountered(da), inventory(i) {}
