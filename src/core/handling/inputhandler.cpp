...
void InputHandler::splitInput(MainWindow *mainWindow, QString input) {
  ...
  verbHandlerObj.handleVerb(mainWindow, verb, target, subject, worldObj.getCurrentLocation());
}

// Inputted verb must match an element of argVerbs or noArgVerbs to be
// considered valid
int InputHandler::validateVerb(QString input) {
  ...
  QMap<QString, int> validVerbs{
      ...
      {"N", VERB_NO_ARG},       {"NORTH", VERB_NO_ARG}, {"PUT", VERB_ARG},
      ...
      {"SKIN", VERB_ARG},       {"SLEEP", VERB_NO_ARG}, {"SOUTH", VERB_NO_ARG},
      ...
      {"WEAR", VERB_ARG},       {"WEST", VERB_NO_ARG}, {"X", VERB_NO_ARG},
